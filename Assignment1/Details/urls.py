...
urlpatterns = [
    ...
    path('department/delete_dept/<int:id>',views.delete,name='delete_department'),
    path('department/update_dept/<int:id>',views.update_dept,name='update_dept'),
    path('department/update_dept/update_department/',views.update_department,name='update_department'),
